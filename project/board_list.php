...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/board_list_style.css">
		...
		<div id="board_box" class="container">
			...
			<ul class="board_list">
				...
				for ($i = $start; $i < $start + $scale && $i < $total_record; $i++) {
					...
					$hit = $row["hit"];
					if ($row["file_name"])
						$file_image = "<i class='bi bi-download'></i>";
					else
						$file_image = " ";
					?>
					<hr>
					<li>
						...
						<div class="col-5"><a href="board_view.php?num=<?= $num ?>&page=<?= $page ?>"><?= $subject ?></a></div>
						<div class="col-1">
							<?= $name ?>
						</div>
						<div class="col-1">
